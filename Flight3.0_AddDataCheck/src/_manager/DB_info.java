...
public class DB_info {
	...
	//root
	//sj521LJ!!
//			public final static String DB_URL = "jdbc:mysql://10.133.1.196:3306/_sjh?characterEncoding=utf8&useSSL=false";//数据库路径
//			public final static String DB_USER = "_sjh";//数据库用户名
//			public final static String DB_PW = "root";//数据密码
		public final static String DB_URL = "jdbc:mysql://10.133.1.196/mysql?characterEncoding=utf8&useSSL=false";//数据库路径
