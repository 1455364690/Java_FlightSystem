...
//		    	addr1l.setFont(new Font("幼圆",Font.BOLD,20));
//		    	addr2l.setFont(new Font("幼圆",Font.BOLD,20));
//		    	totall.setFont(new Font("幼圆",Font.BOLD,20));
//		    	soldl.setFont(new Font("幼圆",Font.BOLD,20));
//		    	startl.setFont(new Font("幼圆",Font.BOLD,20));
//		    	lastl.setFont(new Font("幼圆",Font.BOLD,20));
